...
export const ru = {
  ...
  /* ---- HERO ---- */
  'hero.subtitle':
    'Европейская кухня, кальян, авторский бар и уютная атмосфера',
  ...
  'about.body':
    'THE OFFICE — это лаунж-бар и ресторан европейской кухни в самом сердце Талдыкоргана. Уютный свет, авторские коктейли и ароматный кальян создают вечер, который хочется продлить. Мы готовим и украшаем небольшие праздники под ключ — от дня рождения до камерной вечеринки.',
  'about.humor':
  ...
  'about.feature.bar.title': 'Авторский бар',
  'about.feature.bar.desc':
    'Коктейли, виски, вино и пиво — широкая барная карта для любого вечера.',
  ...
  /* ---- EVENTS & LIVE MUSIC ---- */
  'events.kicker': 'Праздники',
  'events.title': 'Праздники под ключ',
  'events.intro':
    'Дни рождения, корпоративы и камерные вечеринки — оформление, меню и атмосферу берём на себя. Вот праздники, которые мы уже провели:',
  'events.hostedLabel': 'Праздники, которые мы провели',
  ...
  'gallery.intro':
    'Интерьер, блюда, бар и праздники. Загляните внутрь — и захочется зайти лично.',
  ...
  'seo.home.desc':
    'Европейская кухня, авторский бар, кальян и праздники под ключ в Талдыкоргане. Жансугурова 35. Бронь столиков. Ежедневно 12:00–02:00.',
