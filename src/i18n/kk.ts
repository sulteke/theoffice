...
export const kk: Record<keyof typeof ru, string> = {
  ...
  /* ---- HERO ---- */
  'hero.subtitle':
    'Еуропалық тағамдар, кальян, авторлық бар және жайлы атмосфера',
  ...
  // TODO: verify KZ
  'about.body':
    'THE OFFICE — Талдықорған орталығындағы лаунж-бар әрі еуропалық ас үй мейрамханасы. Жайлы жарық, авторлық коктейльдер және хош иісті кальян кешті ұзартқың келгендей етеді. Кішігірім мерекелерді толық ұйымдастырып, безендіреміз — туған күннен шағын кешке дейін.',
  ...
  'about.feature.bar.title': 'Авторлық бар',
  'about.feature.bar.desc':
    'Коктейльдер, виски, шарап және сыра — кез келген кешке арналған бай бар картасы.', // TODO: verify KZ
  // TODO: verify KZ
  ...
  /* ---- EVENTS & LIVE MUSIC ---- */
  'events.kicker': 'Мерекелер',
  'events.title': 'Мерекелерді ұйымдастырамыз',
  // TODO: verify KZ
  'events.intro':
    'Туған күндер, корпоративтер және шағын кештер — безендіру, мәзір және атмосфераны өзімізге аламыз. Міне, біз өткізген мерекелер:',
  'events.hostedLabel': 'Біз өткізген мерекелер',
  ...
  'gallery.intro':
    'Интерьер, тағамдар, бар және мерекелер. Ішке көз салыңыз — өзіңіз келгіңіз келеді.',
  ...
  'cart.service': 'Қызмет көрсету 10%',
  'cart.total': 'Барлығы',
  ...
  'seo.home.desc':
    'Талдықорғандағы еуропалық ас үй, авторлық бар, кальян және мерекелерді ұйымдастыру. Жансүгіров 35. Үстел брондау. Күн сайын 12:00–02:00.',
